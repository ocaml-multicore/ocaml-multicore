...
Error: The type t/158 introduced by this open appears in the signature
       Line 1, characters 46-47:
         The value x has no valid type if t/158 is hidden
|}];;
...
5 |       let x = T
6 |     end
Error: The type t/163 introduced by this open appears in the signature
       Line 7, characters 8-9:
         The value y has no valid type if t/163 is hidden
|}];;
...
4 |       type t = T
5 |     end
Error: The type t/168 introduced by this open appears in the signature
       Line 6, characters 8-9:
         The value y has no valid type if t/168 is hidden
|}]
