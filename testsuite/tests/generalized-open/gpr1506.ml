...
Error: The type t/155 introduced by this open appears in the signature
       Line 1, characters 46-47:
         The value x has no valid type if t/155 is hidden
|}];;
...
4 |       type t = T
5 |     end
Error: The type t/165 introduced by this open appears in the signature
       Line 6, characters 8-9:
         The value y has no valid type if t/165 is hidden
|}]
